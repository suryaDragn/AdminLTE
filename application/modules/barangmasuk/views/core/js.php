...
<script>
  $(document).ready(function() {
    ...
    $('#myData').DataTable({
      ...
      "order": [],
      "ajax": {
        "url": "<?= site_url('barangmasuk/getList'); ?>",
        "type": "POST"
      },
      "columnDefs": [{
    ...
    $('#data').on('click',
      ...
      function() {
        ...
        id = $(this).data('id_barangmasuk');
        $.ajax({
            url:'<?= site_url('barangmasuk/getData'); ?>',
            type:'post',
            dataType:'json',
            data:{
              id_barangmasuk:id,
            },success:function(data){
              $('#id').val(data.id_barangmasuk);
    ...
    $('#data').on('click', '#is_active', function() {
      ...
      $.ajax({
            url:'<?= site_url('barangmasuk/changeActive'); ?>',
            type:'post',
            dataType:'json',
            data:{
              id_barang:id,
